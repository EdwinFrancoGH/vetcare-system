  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      Swal.fire('¡Éxito!', 'Perfil actualizado correctamente.', 'success').then(() => {
        window.location.reload(); // Recargar para obtener los datos más frescos
      });
          ...
          <div className="relative flex justify-between items-end -mt-12 mb-8">
            <div className="relative">
              <div className="w-24 h-24 bg-white rounded-full p-1">
                <div className="w-full h-full bg-zinc-100 rounded-full flex items-center justify-center text-zinc-400 border border-zinc-200">
                  <User size={40} />
                </div>
              </div>
