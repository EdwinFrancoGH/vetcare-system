...
export default function RegisterPage() {
    ...
    const onSubmit = async ({ email, password }) => {
        ...
        try {
            ...
            // api.js ya adjunta el token de Firebase del usuario recién
            // creado (interceptor en services/api.js), así que no hace
            // falta leerlo ni construir la URL a mano aquí.
            await api.post("/auth/sync", { name: email.split('@')[0] });
            ...
            // "/" decide a dónde ir según el rol (todo registro público
            // entra como "Cliente" -> /citas; ver app/page.js y
            // backend/src/controllers/auth.controller.js -> syncUser).
            router.push("/");
        } catch (error) {
